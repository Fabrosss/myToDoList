...
object Tasks {
    ...
    fun updateTask(prevItem: TaskItem, newItem: TaskItem) {
        val indexof = ITEMS.indexOf(prevItem)
        ITEMS.add(indexof,newItem)
        ITEMS.removeAt(indexof+1)
    }
     ...
     */
    data class TaskItem(val id: String, val title: String, val description: String, val importatnce: IMPORTANCE):Parcelable {
        ...
        override fun writeToParcel(parcel: Parcel, flags: Int) {
            ...
            parcel.writeInt(importatnce.ordinal)
        }
